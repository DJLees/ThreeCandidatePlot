...
# Ask if the user wants to filter by a specific seat
filter_seat = input("Do you want to filter by a specific seat? (y/n): ").strip().lower()

if filter_seat == 'y':
    seat_name = input("Enter the name of the seat: ").strip()
    df = df[df['Seat'] == seat_name]  # Replace 'SeatNameColumn' with the actual column name in your CSV
...
scatter_ternary = go.Scatterternary(
    mode='lines',
    a=[50, 0, 50, 50],
    b=[0, 50, 50, 0],
    c=[50, 50, 0, 50],
